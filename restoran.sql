...
--
-- Host: localhost:8889
-- Generation Time: Mar 12, 2023 at 12:36 PM
...
--
ALTER TABLE `obrok`
  MODIFY `redni_broj` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `obrok`
  ADD CONSTRAINT `idkuvar_fk` FOREIGN KEY (`id_kuvar`) REFERENCES `kuvar` (`id_kuvar`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
